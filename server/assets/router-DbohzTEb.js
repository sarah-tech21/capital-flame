...
const appCss = "/assets/styles-CjI0nm8O.css";
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-8xl text-brand-flame", children: "404" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-4 font-display text-2xl", children: "Page Not Found" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "That page doesn't exist. Let's get you back home." }),
...
const $$splitComponentImporter$3 = () => import("./services-DDs_7604.js");
const Route$3 = createFileRoute("/services")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Furnace, A/C, pool heater, gas line, humidifier and BBQ hookups. Repair, install, inspection and maintenance across Ottawa."
    }, {
      property: "og:title",
      content: "Capital Flame Services — HVAC & Pool Heater Ottawa"
    }, {
      property: "og:description",
      content: "Complete home comfort services from a TSSA-certified Ottawa pro."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./contact-eS4KRVXF.js");
const Route$2 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Contact Capital Flame for HVAC, furnace and pool heater service in Ottawa. Call or text 613-422-1125. Open 7 days a week."
    }, {
      property: "og:title",
      content: "Contact Capital Flame — Ottawa HVAC"
    }, {
      property: "og:description",
      content: "Call or text 613-422-1125. Open 7 days. 24/7 emergency service."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./about-DibVoNfq.js");
const Route$1 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Family-run, TSSA-certified Ottawa HVAC contractor with 25+ years of experience. Meet Philippe and the Capital Flame team."
    }, {
      property: "og:title",
      content: "About Capital Flame — Ottawa HVAC"
    }, {
      property: "og:description",
      content: "25+ years of honest, professional home comfort service across Ottawa."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-CusIzV3t.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "5-star rated HVAC contractor in Ottawa. Furnace, A/C and pool heater repair, install & maintenance. TSSA certified. 25+ years. Call 613-422-1125."
    }, {
      property: "og:title",
      content: "Capital Flame — Ottawa HVAC & Pool Heater Experts"
    }, {
      property: "og:description",
      content: "Trusted by Ottawa homeowners for 25+ years. Bilingual service, 24/7 emergency, open 7 days."
    }]
  }),
